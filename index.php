  ...
  <div class="contenedor">
    <form action="#" method="post">
      <div class="mb-3 element">
        ...
        <select name="nombreEncuesta" class="form-select" id="tituloEncuesta" disabled>
        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="usuario" placeholder="Luis Hern&aacute;ndez" aria-describedby="Nombre de usuario" autocomplete="off"/>
            </div>
          </div>
          <div class="col">
            <div class="mb-3">
              <label for="usuario" class="form-label">Empresa</label>
              <input type="text" class="form-control" id="empresa" placeholder="Los cochilocos S.A. de C.V." aria-describedby="Nombre de la empresa" autocomplete="off"/>
            </div>
          </div>
        </div>
      </div>
